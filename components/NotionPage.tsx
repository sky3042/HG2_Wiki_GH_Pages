...
export function NotionPage({
  ...
  const components = React.useMemo<Partial<NotionComponents>>(
    () => ({
      ...
      propertyTextValue,
      propertyDateValue,
      PageCover: config.isPageCoverEnabled ? undefined : () => null
    }),
    []
  )
  ...
  const socialImage = mapImageUrl(
    ...
    block,
    recordMap
  ) || (config.defaultPageCover ? (config.defaultPageCover.startsWith('http') ? config.defaultPageCover : `${config.host}${config.defaultPageCover}`) : undefined)
  ...
  return (
    <>
      ...
      <NotionRenderer
        ...
        mapImageUrl={(url, block) => mapImageUrl(url, block, recordMap)}
